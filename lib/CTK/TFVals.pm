package CTK::TFVals; # $Id: TFVals.pm 180 2014-04-14 19:59:32Z minus $
use strict;
...
This function returns true if argument ~ \d{1,11} and 
argument value > 0 && < 99999999999
...
L</"tv2num">, L</"tv2number">, L</"tv2flt">, L</"tv2float">, L</"tv2int">, L</"tv2int8">, L</"tv2int16">, L</"tv2int32">

=head3 CHCK

L</"is_num">, L</"is_flt">, L</"is_int">, L</"is_int8">, L</"is_int16">, L</"is_int32">
...
our %EXPORT_TAGS = (
        ...
        TRUE     => [qw/
                tv2num tv2number
                tv2flt tv2float
                tv2int tv2int8 tv2int16 tv2int32
            /],
        CHCK     => [qw/
                is_num is_flt is_int is_int8 is_int16 is_int32
            /],
    );
